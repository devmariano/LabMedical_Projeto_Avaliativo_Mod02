...
const PatientUpdateForm = () => {
    ...
    const onSubmit = (data) => {
        ...
        try {
            ...
            const newPatient = PatientService.updatePatient(parsedId, data);
        } catch (error) {
    ...
    return (
        ...
        <EqualDivider>
            <Child><h3>Atualização de cadastro</h3>
            </Child>
            <Child>
            <StyledButton type="submit">Salvar</StyledButton>
            <StyledButton type="button" $delete onClick={handleDeletePatient}>Deletar</StyledButton>
            </Child>
            <Child>
